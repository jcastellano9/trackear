...
type CryptoRatesTableProps = {
  currencyRates: [string, InterestRate[]][];
};

export function CryptoRatesTable({ currencyRates }: CryptoRatesTableProps) {
  return (
    <>
      {currencyRates.map(([currency, rates]) => (
