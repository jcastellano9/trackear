                  ...
                  {providers.map(provider => (
                    <TableHead key={provider} className="text-center">
                      <div className="flex flex-col items-center gap-1 py-2">
                        {provider === "Buenbit" && (
                          <img src="https://play-lh.googleusercontent.com/2Rc-l3M-xNHrw9Ix43Z9-99ntLYBFZO6O8gYBHQXQyuR1QxPfFRUnp9n-oRR3ioFwQ" alt="Buenbit" className="h-8 w-8 rounded-full" />
                        )}
                        {provider === "Lemon" && (
                          <img src="https://play-lh.googleusercontent.com/Vd4W8OxV1z6VP0xTZxLrVyh5CfQN5pM8GUwDI8zBn5NYmj6w3Ao_V_6a0FHRcCsg0cw" alt="Lemon" className="h-8 w-8 rounded-full" />
                        )}
                        {provider === "Belo" && (
                          <img src="https://play-lh.googleusercontent.com/RoAXmMNHCURBW8FtDzx7Ex1_oKQRdO71-A8Jyz6uxA6K9wuLMc41PsHPDyJpxxRRXg" alt="Belo" className="h-8 w-8 rounded-full" />
                        )}
                        {provider === "Ripio" && (
                          <img src="https://play-lh.googleusercontent.com/FudHuxG1Fnrpn21RxooK1XneYMgzAmi7Qb8Uds8cW-bCn1GC4hkMOVgRgDjQXZDM70w" alt="Ripio" className="h-8 w-8 rounded-full" />
                        )}
                        {provider === "Fiwind" && (
                          <img src="https://fiwind.io/favicon/android-chrome-192x192.png" alt="Fiwind" className="h-8 w-8 rounded-full" />
                        )}
                        {provider === "SatoshiTango" && (
                          <img src="https://play-lh.googleusercontent.com/72NVZ6HZnf91C3okaC2Xl7npHDj6PpuKGZlrWfLv3qJPg_4m-n4pR_nrOGiQGpQ8rA" alt="SatoshiTango" className="h-8 w-8 rounded-full" />
                        )}
                        {provider === "LB" && (
                          <img src="https://play-lh.googleusercontent.com/WQDQpVJa28N_UpNHGBxqgUUm2bDqfCtz7lkbR2IaL3MFbkCEZKOCmpXOXMcxD6dOUas" alt="Let's Bit" className="h-8 w-8 rounded-full" />
                        )}
